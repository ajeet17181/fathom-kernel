...
int report_battery_percent(){
if (max17040_dev)
	return max17040_dev->percent_level;
 else
	return 100;
}

EXPORT_SYMBOL(report_battery_percent);

static int __devinit max17040_probe(struct i2c_client *i2c_dev, const struct i2c_device_id *i2c_dev_id)
{
