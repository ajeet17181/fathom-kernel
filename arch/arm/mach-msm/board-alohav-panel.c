...
#define GPIO_OUT_132    150 //spi_clk
#define GPIO_OUT_131    151 //spi_cs
#define GPIO_OUT_103    148 //sdi
#define GPIO_OUT_102    149 //sdoi
#define GPIO_OUT_88     88


#define GPIO_OUT_84		156 // reset
#define GPIO_IN_85		155  // Maker id
